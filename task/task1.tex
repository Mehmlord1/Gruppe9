...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{./../diagram/classes_files.pdf}
...
\subsection{Aufbau}
Es gibt drei Dateien, "dataset.py", "main.py" und "implementation.py"\footnotemark.
...
\footnotetext{Dateien befinden sich im Ordner "/code/" dieses Git-Repositories.}
\end{document}